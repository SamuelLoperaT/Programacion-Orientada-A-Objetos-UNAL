...
private JButton cilindro, esfera, pirámide,cubo,cono,prismaTriangulo;
/**
...
setSize(350,200); // Establece el tamaño de la ventana
...
cubo = new JButton();
cubo.setText("Cubo");
cubo.setBounds(20, 100, 80, 23); /* Establece la posición del 
botón del cilindro */
...
/* Agrega al botón un ActionListener para que gestione eventos 
del botón */
// Establece el botón del Cono
cono = new JButton();
cono.setText("Cono");
cono.setBounds(125, 100, 80, 23); /* Establece la posición del 
botón del cilindro */
...
prismaTriangulo = new JButton();
prismaTriangulo.setText("Prisma △");
prismaTriangulo.setBounds(225, 100, 100, 23); /* Establece la posición del 
botón del cilindro */

/* Agrega al botón un ActionListener para que gestione eventos 
del botón */
prismaTriangulo.addActionListener(this);
/* Agrega al botón un ActionListener para que gestione eventos 
del botón */
...
contenedor.add(cubo);
contenedor.add(cono);
contenedor.add(prismaTriangulo);
}
/**
...
if (evento.getSource() == cubo) { /* Si se pulsa el botón 
    Cubo */
    VentanaCubo cubo = new VentanaCubo(); /* Crea 
    la ventana del Cubo */
    cubo.setVisible(true); /* Establece que se visualice la 
    ventana del cubo */
}
if (evento.getSource() == cono) { // Si se pulsa el botón cono
    VentanaCono cono = new VentanaCono(); /* Crea la 
    ventana de la cono */
    cono.setVisible(true); /* Establece que se visualice la ventana 
    del cono */
    }
if (evento.getSource() == prismaTriangulo) { // Si se pulsa el botón cono
    VentanaPrismaTriangular prismaTriangular = new VentanaPrismaTriangular(); /* Crea la 
    ventana de la cono */
    prismaTriangular.setVisible(true); /* Establece que se visualice la ventana 
    del cono */
    }
}
}